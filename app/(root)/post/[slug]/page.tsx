...
import BlogNav from "@/components/component/BlogNav";
...
export default async function SlugPage({
  ...
  return (
    ...
    <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
      ...
      <div className="divide-y divide-gray-700 xl:divide-y-0">
        <div className="divide-y divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
          <div className="prose max-w-none pb-8 pt-10 prose-invert prose-lg">
            <PortableText
              value={data.content}
